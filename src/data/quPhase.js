export default {
  "histoire-de-la-science": {
    slides: [
      {
        text: "Marie Curie est une savante exceptionnelle. Née en Pologne, elle fait ses études à la faculté des sciences de Paris. Marie fait partie des rares femmes qui y sont admises. C’est là qu’elle rencontre Pierre Curie, avec qui elle se marie. Ensemble, ils travaillent sur l’étude des rayons X et découvrent deux éléments radioactifs : le polonium et le radium. En 1903, le couple reçoit le prix Nobel de physique. Pendant la Première Guerre mondiale, elle met en place des ambulances équipées d’appareils de radiologie, ce qui permet de sauver de nombreux blessés. Marie Curie est la première femme à avoir reçu un prix Nobel pour ses découvertes. Elle en a même reçu deux, l’un avec Pierre Curie en physique, et l’autre pour ses recherches en chimie. ",
        image: "/pics-intervention-qa/Il était une fois la science/MarieCurie.jpg",
        questions: [
          {
            starter: "Quel(le)",
            options: [
              "Voir ce qu'il y'a à l'intérieur de la matière",
              "Première femme professeure à la Sorbonne",
              "ça peut causer des maladies",
            ]
          },
          {
            starter: "Comment",
            options: [
              "Voir l'anomalie dans le coprs d'un malade",
              "Petites Curies",
              "Un cancer",
            ]
          }
      ...
      {
        text: `Albert Einstein est un savant hors du commun, indiscipliné et brillant. Il est
        considéré comme l’un des plus grands scientifiques du XXe siècle. Il est
        également connu pour ses idées pacifiques.
        Mauvais élève quand il était petit, Albert se démarque vite par ses recherches. 
        Il obtient son diplôme de l’École polytechnique de Zurich, en Suisse, et reçoit
        ensuite le prix Nobel de physique pour ses découvertes. Dans les années 1930,
        la situation politique en Allemagne se dégrade. Einstein, d’origine juive, quitte
        l’Europe pour les États-Unis et y devient professeur. 
        À son grand désespoir, ce pays se sert de ses recherches pour créer et utiliser 
        ...
        questions: [
          {
            starter: "Comment",
            options: [
              "Il apprenait les mathématiques tout seul",
              "Il s'est enfui",
          ...
          },
          {
            starter: "Quel(le)",
            options: [
              "Comprendre l'origine du monde ",
              "Le Japon",
              "L'utiliser pour gagner des guerres",
            ]
          }
        ]
      ...
      {
        text: `Louis Pasteur naît en 1822. Après ses études, il devient professeur de physique-chimie à Dijon, puis à Strasbourg. En 1865, il découvre une façon de conserver les aliments plus longtemps : on appelle cela la pasteurisation. Dans les années 1880, alors qu’il combat le choléra chez les animaux, il lui vient une idée géniale : innoculer en petite quantité la maladie pour que le corps renforce sa capacité à se défendre. Il invente ainsi le principe de la vaccination. Il recommence l’expérience lorsqu’un petit garçon atteint de rage arrive dans son laboratoire. C’est un succès ! En 1888, Pasteur ouvre un institut dédié à la vaccination et à la recherche. Très vite, d’autres instituts ouvrent dans le monde entier.`,
        image: "/pics-intervention-qa/Il était une fois la science/LouisPasteur.jpg",
        questions: [
          {
            starter: "Comment",
            options: [
              "Chauffer puis refroidir brusquement",
              "Une personne très discrète",
              "Il s'appuyait sur d'autres idées scientifiques",
            ]
          },
          {
            starter: "Quel(s)",
            options: [
              "Des echecs ",
              "Arreter la contagion d'une maladie",
      ...
      {
        text: `Alan Turing est né en 1912 à Paddington. Alan Mathison Turing est un célèbre mathématicien. Élève surdoué et précoce, son génie est vite repéré par ses proches et ses professeurs : il aurait appris à lire seul en trois semaines. Pendant la Seconde Guerre mondiale, Turing a travaillé sur le déchiffrement des messages allemands, permettant ainsi aux Alliés de remporter des batailles importantes. Turing est aussi un pionnier de l'informatique. Il a étudié l'intelligence artificielle et travaillé sur les premiers ordinateurs. Il a élaboré le test de Turing, une méthode qui permet de vérifier qu'un programme est capable de simuler les réponses d'un être humain sans que celui-ci se rende compte qu'il parle avec un ordinateur.`,
        image: "/pics-intervention-qa/Il était une fois la science/Alan Turing.jpg",
        questions: [
          {
            starter: "Quel(s)",
            options: [
              "Un algorithme qui peut jouer aux échecs",
              "Anglaise",
              "Royaume-Uni, France et Etats-Unis",
            ]
          },
          {
            starter: "Comment",
            options: [
              ...
              "Le père des machines intelligentes",
              "Deux ans de guerre de moins",
            ]
          }
        ]
      ...
      {
        text: `Gustave Eiffel, né sous le nom de Bönickhausen en décembre 1832 à Dijon et mort le en décembre 1923 à Paris, est un ingénieur français. Ayant échoué à l'oral du concours d'entrée à l'École polytechnique, il suit les cours de l'École centrale des arts et manufactures où il obtient son diplôme d'ingénieur. Il travaille tout d'abord dans la construction des chemins de fer. A 26 ans, il dirige la construction du pont de Bordeaux. En 1864, il installe ses ateliers à Levallois-Perret prés de Paris.  Il deviendra ensuite un pionnier de l'architecture métallique. Il a notamment construit : le viaduc Maria Pia, à Porto, au Portugal (1877) ; le viaduc de Garabit, dans le Cantal, en France (1884) ; la structure métallique de la statue de la Liberté (1886) ; la tour Eiffel (de 1887 à 1889).`,
      ...
      {
        text: `Rosalind Franklin est née en 1920, elle est pionnière britannique de la biologie moléculaire, a découvert la structure de l'acide désoxyribonucléique (ADN). Élève brillante, Rosalind Franklin intègre à 11 ans un des seuls établissements de Londres où la physique et la chimie sont enseignées aux jeunes filles. Dès 1956, la santé de Rosalind Franklin se dégrade en raison des suites d'un cancer. Après plusieurs traitements, elle décède finalement à Londres,à seulement 38 ans. En 1962,ce sont ses collègues James Watson,Francis Crick et Maurice Wilkins qui obtiennent le prix Nobel pour la découverte de la structure à double hélice de l'ADN sans citer Rosalind Franklin. Rosalind Franklin, malgré son rôle primordial, ne sera malheureusement pas récompensée ou à titre posthume.`,
        image: "/pics-intervention-qa/Il était une fois la science/RosalindFranklin.jpg",
        questions: [
          {
            starter: "Quel(e)",
            options: [
              "Transmet les informations héréditaires des parents aux enfants ",
              "Une molécule",
              "Garde dans l'armée",
            ]
          },
          {
            starter: "Pourquoi",
            options: [
              "Sur-esxposée à des rayons dangereux",
              "Ses collègues ont nié sa participation à la découverte",
              "Elle a aussi découvert un virus",
            ]
          }
        ]
      }
